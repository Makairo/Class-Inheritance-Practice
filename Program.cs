    ...
    class Program
    {
        static void Main(string[] args)
        {
            try
            {
                ...
                //Officer will print what the step of the mission is, enlisted carry it out.
                //Again, equipment is only useable by the enlisted class, but you can call the methods seperately.
            ...
            {
                Console.WriteLine("All missions complete. Thank you for running my program.");
            }
        }
    }
}
